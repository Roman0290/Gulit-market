...
import (
	...
	"github.com/romina/pocket-market-api/internal/banners"
...
func main() {
	...
	bannerRepo := banners.NewRepository(conn)
	bannerHandler := banners.NewHandler(bannerRepo)
	...
	bannerHandler.RegisterRoutes(v1, authService)
